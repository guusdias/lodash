(function (window) {
  ...
  addEventListener('load', () => {
    ...
    function eventHandler(event) {
      ...
      const loaderIndex = loaderList.selectedIndex;
      const search = location.search.replace(/^\?|&?(?:build|loader)=[^&]*&?/g, '');
    ...
    span1.innerHTML = '<label for="qunit-build">Build: </label>'
    ...
    span2.innerHTML = '<label for="qunit-loader">Loader: </label>'
    ...
    var loaderList = span2.lastChild;
